    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <Card>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-blue-300 rounded-md shadow-sm 
                             focus:outline-none focus:ring-primary-500 focus:border-primary-500
                             text-base placeholder-blue-400"
                  >
          ...
          <CardFooter className="flex flex-col space-y-4 pt-4 border-t border-blue-200">
